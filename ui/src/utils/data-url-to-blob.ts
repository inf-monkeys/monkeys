// ref: https://github.com/transloadit/uppy/blob/ca0a7864c9e78e23c69450df8dc2bab338a1a288/packages/%40uppy/utils/src/dataURItoBlob.ts
...
function dataURItoBlob(dataURI: string, opts: dataURItoBlobOptions, toFile: true): File;

function dataURItoBlob(dataURI: string, opts: dataURItoBlobOptions, toFile?: boolean): Blob | File {
  // get the base64 data
