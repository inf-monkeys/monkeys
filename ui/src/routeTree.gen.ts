...
const TeamIdVrEvaluationsIndexLazyImport = createFileRoute('/$teamId/vr-evaluations/')();
const TeamIdToolsIndexLazyImport = createFileRoute('/$teamId/tools/')();
const TeamIdTextModelsIndexLazyImport = createFileRoute('/$teamId/text-models/')();
const TeamIdTextModelStoreIndexLazyImport = createFileRoute('/$teamId/text-model-store/')();
const TeamIdTextDataIndexLazyImport = createFileRoute('/$teamId/text-data/')();
const TeamIdTextDataStoreIndexLazyImport = createFileRoute('/$teamId/text-data-store/')();
...
const TeamIdRenderToolsIndexLazyImport = createFileRoute('/$teamId/render-tools/')();
...
const TeamIdImageModelsIndexLazyImport = createFileRoute('/$teamId/image-models/')();
const TeamIdImageModelStoreIndexLazyImport = createFileRoute('/$teamId/image-model-store/')();
const TeamIdDesignsIndexLazyImport = createFileRoute('/$teamId/designs/')();
const TeamIdDesignSoftwareEvaluationsIndexLazyImport = createFileRoute('/$teamId/design-software-evaluations/')();
const TeamIdComfyuiIndexLazyImport = createFileRoute('/$teamId/comfyui/')();
const TeamIdComfyuiStoreIndexLazyImport = createFileRoute('/$teamId/comfyui-store/')();
const TeamIdChatV2IndexLazyImport = createFileRoute('/$teamId/chat-v2/')();
const TeamIdApplicationStoreIndexLazyImport = createFileRoute('/$teamId/application-store/')();
...
const TeamIdActionToolsIndexLazyImport = createFileRoute('/$teamId/action-tools/')();
const TeamIdWorkspaceWorkflowIdIndexLazyImport = createFileRoute('/$teamId/workspace/$workflowId/')();
const TeamIdTextModelsLlmModelIdIndexLazyImport = createFileRoute('/$teamId/text-models/$llmModelId/')();
const TeamIdTextDataTextIdIndexLazyImport = createFileRoute('/$teamId/text-data/$textId/')();
const TeamIdTableDataDatabaseIdIndexLazyImport = createFileRoute('/$teamId/table-data/$databaseId/')();
const TeamIdNavNavIdIndexLazyImport = createFileRoute('/$teamId/nav/$navId/')();
const TeamIdImageModelsImageModelIdIndexLazyImport = createFileRoute('/$teamId/image-models/$imageModelId/')();
const TeamIdEvaluationsModuleIdIndexLazyImport = createFileRoute('/$teamId/evaluations/$moduleId/')();
const TeamIdDesignDesignProjectIdIndexLazyImport = createFileRoute('/$teamId/design/$designProjectId/')();
const TeamIdComfyuiComfyuiWorkflowIdIndexLazyImport = createFileRoute('/$teamId/comfyui/$comfyuiWorkflowId/')();
const TeamIdAgentAgentIdIndexLazyImport = createFileRoute('/$teamId/agent/$agentId/')();
const TeamIdActionToolsActionToolNameIndexLazyImport = createFileRoute('/$teamId/action-tools/$actionToolName/')();
const TeamIdWorkspaceWorkflowIdImageDetailIndexLazyImport = createFileRoute(
  '/$teamId/workspace/$workflowId/image-detail/',
)();
const TeamIdWorkspaceWorkflowIdPageIdIndexLazyImport = createFileRoute('/$teamId/workspace/$workflowId/$pageId/')();
const TeamIdNavNavIdSubModuleIdIndexLazyImport = createFileRoute('/$teamId/nav/$navId/$subModuleId/')();
const TeamIdEvaluationsModuleIdTabIndexLazyImport = createFileRoute('/$teamId/evaluations/$moduleId/$tab/')();
...
const TeamIdNavNavIdAssetAssetIdIndexLazyImport = createFileRoute('/$teamId/nav/$navId/asset/$assetId/')();
...
const TeamIdWorkspaceIndexLazyRoute = TeamIdWorkspaceIndexLazyImport.update({
  ...
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/workspace/index.lazy').then((d) => d.Route));

const TeamIdWorkflowsIndexLazyRoute = TeamIdWorkflowsIndexLazyImport.update({
  path: '/$teamId/workflows/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/workflows/index.lazy').then((d) => d.Route));

const TeamIdWorkbenchIndexLazyRoute = TeamIdWorkbenchIndexLazyImport.update({
  path: '/$teamId/workbench/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/workbench/index.lazy').then((d) => d.Route));

const TeamIdVrEvaluationsIndexLazyRoute = TeamIdVrEvaluationsIndexLazyImport.update({
  path: '/$teamId/vr-evaluations/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/vr-evaluations/index.lazy').then((d) => d.Route));

const TeamIdToolsIndexLazyRoute = TeamIdToolsIndexLazyImport.update({
  path: '/$teamId/tools/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/tools/index.lazy').then((d) => d.Route));

const TeamIdTextModelsIndexLazyRoute = TeamIdTextModelsIndexLazyImport.update({
  path: '/$teamId/text-models/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/text-models/index.lazy').then((d) => d.Route));

const TeamIdTextModelStoreIndexLazyRoute = TeamIdTextModelStoreIndexLazyImport.update({
  path: '/$teamId/text-model-store/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/text-model-store/index.lazy').then((d) => d.Route));

const TeamIdTextDataIndexLazyRoute = TeamIdTextDataIndexLazyImport.update({
  path: '/$teamId/text-data/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/text-data/index.lazy').then((d) => d.Route));

const TeamIdTextDataStoreIndexLazyRoute = TeamIdTextDataStoreIndexLazyImport.update({
  path: '/$teamId/text-data-store/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/text-data-store/index.lazy').then((d) => d.Route));

const TeamIdTableDataIndexLazyRoute = TeamIdTableDataIndexLazyImport.update({
  path: '/$teamId/table-data/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/table-data/index.lazy').then((d) => d.Route));

const TeamIdStoreIndexLazyRoute = TeamIdStoreIndexLazyImport.update({
  path: '/$teamId/store/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/store/index.lazy').then((d) => d.Route));

const TeamIdSettingsIndexLazyRoute = TeamIdSettingsIndexLazyImport.update({
  path: '/$teamId/settings/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/settings/index.lazy').then((d) => d.Route));

const TeamIdRenderToolsIndexLazyRoute = TeamIdRenderToolsIndexLazyImport.update({
  path: '/$teamId/render-tools/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/render-tools/index.lazy').then((d) => d.Route));

const TeamIdNavIndexLazyRoute = TeamIdNavIndexLazyImport.update({
  path: '/$teamId/nav/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/nav/index.lazy').then((d) => d.Route));

const TeamIdMediaDataIndexLazyRoute = TeamIdMediaDataIndexLazyImport.update({
  path: '/$teamId/media-data/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/media-data/index.lazy').then((d) => d.Route));

const TeamIdJoinTeamIndexLazyRoute = TeamIdJoinTeamIndexLazyImport.update({
  path: '/$teamId/join-team/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/join-team/index.lazy').then((d) => d.Route));

const TeamIdImageModelsIndexLazyRoute = TeamIdImageModelsIndexLazyImport.update({
  path: '/$teamId/image-models/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/image-models/index.lazy').then((d) => d.Route));

const TeamIdImageModelStoreIndexLazyRoute = TeamIdImageModelStoreIndexLazyImport.update({
  path: '/$teamId/image-model-store/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/image-model-store/index.lazy').then((d) => d.Route));

const TeamIdDesignsIndexLazyRoute = TeamIdDesignsIndexLazyImport.update({
  path: '/$teamId/designs/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/designs/index.lazy').then((d) => d.Route));

const TeamIdDesignSoftwareEvaluationsIndexLazyRoute = TeamIdDesignSoftwareEvaluationsIndexLazyImport.update({
  path: '/$teamId/design-software-evaluations/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/design-software-evaluations/index.lazy').then((d) => d.Route));

const TeamIdComfyuiIndexLazyRoute = TeamIdComfyuiIndexLazyImport.update({
  path: '/$teamId/comfyui/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/comfyui/index.lazy').then((d) => d.Route));

const TeamIdComfyuiStoreIndexLazyRoute = TeamIdComfyuiStoreIndexLazyImport.update({
  path: '/$teamId/comfyui-store/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/comfyui-store/index.lazy').then((d) => d.Route));

const TeamIdChatV2IndexLazyRoute = TeamIdChatV2IndexLazyImport.update({
  path: '/$teamId/chat-v2/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/chat-v2/index.lazy').then((d) => d.Route));

const TeamIdApplicationStoreIndexLazyRoute = TeamIdApplicationStoreIndexLazyImport.update({
  path: '/$teamId/application-store/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/application-store/index.lazy').then((d) => d.Route));

const TeamIdAgentsIndexLazyRoute = TeamIdAgentsIndexLazyImport.update({
  path: '/$teamId/agents/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/agents/index.lazy').then((d) => d.Route));

const TeamIdAgentIndexLazyRoute = TeamIdAgentIndexLazyImport.update({
  path: '/$teamId/agent/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/agent/index.lazy').then((d) => d.Route));

const TeamIdActionToolsIndexLazyRoute = TeamIdActionToolsIndexLazyImport.update({
  path: '/$teamId/action-tools/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/action-tools/index.lazy').then((d) => d.Route));
...
const TeamIdWorkspaceWorkflowIdIndexLazyRoute = TeamIdWorkspaceWorkflowIdIndexLazyImport.update({
  path: '/$teamId/workspace/$workflowId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/workspace/$workflowId/index.lazy').then((d) => d.Route));

const TeamIdTextModelsLlmModelIdIndexLazyRoute = TeamIdTextModelsLlmModelIdIndexLazyImport.update({
  path: '/$teamId/text-models/$llmModelId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/text-models/$llmModelId/index.lazy').then((d) => d.Route));

const TeamIdTextDataTextIdIndexLazyRoute = TeamIdTextDataTextIdIndexLazyImport.update({
  path: '/$teamId/text-data/$textId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/text-data/$textId/index.lazy').then((d) => d.Route));

const TeamIdTableDataDatabaseIdIndexLazyRoute = TeamIdTableDataDatabaseIdIndexLazyImport.update({
  path: '/$teamId/table-data/$databaseId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/table-data/$databaseId/index.lazy').then((d) => d.Route));

const TeamIdNavNavIdIndexLazyRoute = TeamIdNavNavIdIndexLazyImport.update({
  path: '/$teamId/nav/$navId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/nav/$navId/index.lazy').then((d) => d.Route));

const TeamIdImageModelsImageModelIdIndexLazyRoute = TeamIdImageModelsImageModelIdIndexLazyImport.update({
  path: '/$teamId/image-models/$imageModelId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/image-models/$imageModelId/index.lazy').then((d) => d.Route));

const TeamIdEvaluationsModuleIdIndexLazyRoute = TeamIdEvaluationsModuleIdIndexLazyImport.update({
  path: '/$teamId/evaluations/$moduleId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/evaluations/$moduleId/index.lazy').then((d) => d.Route));

const TeamIdDesignDesignProjectIdIndexLazyRoute = TeamIdDesignDesignProjectIdIndexLazyImport.update({
  path: '/$teamId/design/$designProjectId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/design/$designProjectId/index.lazy').then((d) => d.Route));

const TeamIdComfyuiComfyuiWorkflowIdIndexLazyRoute = TeamIdComfyuiComfyuiWorkflowIdIndexLazyImport.update({
  path: '/$teamId/comfyui/$comfyuiWorkflowId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/comfyui/$comfyuiWorkflowId/index.lazy').then((d) => d.Route));

const TeamIdAgentAgentIdIndexLazyRoute = TeamIdAgentAgentIdIndexLazyImport.update({
  path: '/$teamId/agent/$agentId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/agent/$agentId/index.lazy').then((d) => d.Route));

const TeamIdActionToolsActionToolNameIndexLazyRoute = TeamIdActionToolsActionToolNameIndexLazyImport.update({
  path: '/$teamId/action-tools/$actionToolName/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/action-tools/$actionToolName/index.lazy').then((d) => d.Route));

const TeamIdModelTrainingModelTrainingIdIndexRoute = TeamIdModelTrainingModelTrainingIdIndexImport.update({
  path: '/$teamId/model-training/$modelTrainingId/',
  getParentRoute: () => rootRoute,
} as any);

const TeamIdWorkspaceWorkflowIdImageDetailIndexLazyRoute = TeamIdWorkspaceWorkflowIdImageDetailIndexLazyImport.update({
  path: '/$teamId/workspace/$workflowId/image-detail/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/workspace/$workflowId/image-detail/index.lazy').then((d) => d.Route));

const TeamIdWorkspaceWorkflowIdPageIdIndexLazyRoute = TeamIdWorkspaceWorkflowIdPageIdIndexLazyImport.update({
  path: '/$teamId/workspace/$workflowId/$pageId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/workspace/$workflowId/$pageId/index.lazy').then((d) => d.Route));

const TeamIdNavNavIdSubModuleIdIndexLazyRoute = TeamIdNavNavIdSubModuleIdIndexLazyImport.update({
  path: '/$teamId/nav/$navId/$subModuleId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/nav/$navId/$subModuleId/index.lazy').then((d) => d.Route));

const TeamIdEvaluationsModuleIdTabIndexLazyRoute = TeamIdEvaluationsModuleIdTabIndexLazyImport.update({
  path: '/$teamId/evaluations/$moduleId/$tab/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/evaluations/$moduleId/$tab/index.lazy').then((d) => d.Route));
...
const TeamIdDesignDesignProjectIdDesignBoardIdIndexLazyRoute =
  TeamIdDesignDesignProjectIdDesignBoardIdIndexLazyImport.update({
    ...
    import('./pages/$teamId/design/$designProjectId/$designBoardId/index.lazy').then((d) => d.Route),
  );

const TeamIdWorkspaceWorkflowIdPageIdViewIframeLazyRoute = TeamIdWorkspaceWorkflowIdPageIdViewIframeLazyImport.update({
  path: '/$teamId/workspace/$workflowId/$pageId/view-iframe',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/workspace/$workflowId/$pageId/view-iframe.lazy').then((d) => d.Route));

const TeamIdNavNavIdAssetAssetIdIndexLazyRoute = TeamIdNavNavIdAssetAssetIdIndexLazyImport.update({
  path: '/$teamId/nav/$navId/asset/$assetId/',
  getParentRoute: () => rootRoute,
} as any).lazy(() => import('./pages/$teamId/nav/$navId/asset.$assetId/index.lazy').then((d) => d.Route));
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/$teamId/vr-evaluations/': {
      preLoaderRoute: typeof TeamIdVrEvaluationsIndexLazyImport;
      parentRoute: typeof rootRoute;
    };
    '/$teamId/workbench/': {
...
export const routeTree = rootRoute.addChildren([
  ...
  TeamIdVrEvaluationsIndexLazyRoute,
