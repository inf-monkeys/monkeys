...
export const BrushBar: React.FC<IBrushBarProps> = ({
  ...
  return (
    <>
      <div className="bg-dialog absolute bottom-10 left-1 flex flex-col items-center gap-1 rounded border border-input p-1 opacity-85 transition-opacity hover:opacity-100">
        <Tooltip>
      ...
      <div
        className="bg-dialog absolute bottom-1 left-1 flex items-center justify-center gap-2 rounded border border-input p-2 opacity-85 transition-opacity hover:opacity-100"
