  ...
  (
    ...
    return (
      <textarea
        ...
        ref={textAreaRef}
        className={cn(
          'flex w-full rounded-md border border-input bg-[#FFFFFF] px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-vines-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-[#111113]',
          className,
        )}
        onChange={(e) => {
