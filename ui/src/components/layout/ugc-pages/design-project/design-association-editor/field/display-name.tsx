...
export const FieldDisplayName: React.FC<IFieldDisplayNameProps> = ({ form }) => {
  ...
  return (
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          <FormLabel>{t('ugc-page.design-project.association-editor.editor.field.display-name.label')}</FormLabel>
          <FormControl>
            <div className="relative">
              <Input
                placeholder={t('ugc-page.design-project.association-editor.editor.field.display-name.placeholder')}
                value={getCurrentLanguageValue(i18nDisplayName)}
                onChange={(value) => handleMainInputChange(value)}
                      ...
                      return (
                        <div key={languageKey} className="gap-global flex flex-col">
                          ...
                          <Input
                            ...
                            placeholder={t(
                              'ugc-page.design-project.association-editor.editor.field.display-name.placeholder',
                            )}
