  ...
  return (
    <FormField
      ...
      render={({ field: { value, ...field } }) => (
        <FormItem>
          <FormLabel>{t('ugc-page.design-project.association-editor.editor.field.target-workflow-id.label')}</FormLabel>
          <FormControl>
            <Popover open={visible} onOpenChange={setVisible}>
                  ...
                  >
                    {value
                      ...
                      : isLoading
                        ...
                        : t('ugc-page.design-project.association-editor.editor.field.target-workflow-id.placeholder')}
              ...
              <PopoverContent className="p-0">
                <Command>
                  <CommandInput
                    placeholder={t(
                      'ugc-page.design-project.association-editor.editor.field.target-workflow-id.search-placeholder',
                    )}
                  />
                  <CommandEmpty>
                    {t('ugc-page.design-project.association-editor.editor.field.target-workflow-id.search-empty')}
                  </CommandEmpty>
