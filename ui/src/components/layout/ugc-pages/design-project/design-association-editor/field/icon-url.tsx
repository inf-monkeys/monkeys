...
export const FieldIconUrl: React.FC<IFieldIconUrlProps> = ({ form }) => {
  ...
  return (
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          <FormLabel>{t('ugc-page.design-project.association-editor.editor.field.icon-url.label')}</FormLabel>
          <FormControl>
              ...
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogTrigger asChild>
                  <Button variant="outline" className="flex items-center gap-2">
                    <EditIcon size={16} />
                    {t('ugc-page.design-project.association-editor.editor.field.icon-url.select-icon')}
                  </Button>
                </DialogTrigger>
                <DialogContent>
                  <DialogTitle>
                    {t('ugc-page.design-project.association-editor.editor.field.icon-url.dialog-title')}
                  </DialogTitle>
