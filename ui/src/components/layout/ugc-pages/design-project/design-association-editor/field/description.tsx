...
export const FieldDescription: React.FC<IFieldDescriptionProps> = ({ form }) => {
  ...
  return (
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          <FormLabel>{t('ugc-page.design-project.association-editor.editor.field.description.label')}</FormLabel>
          <FormControl>
            <div className="relative">
              <Textarea
                placeholder={t('ugc-page.design-project.association-editor.editor.field.description.placeholder')}
                      ...
                      return (
                        <div key={languageKey} className="gap-global flex flex-col">
                          ...
                          <Textarea
                            ...
                            placeholder={t(
                              'ugc-page.design-project.association-editor.editor.field.description.placeholder',
                            )}
