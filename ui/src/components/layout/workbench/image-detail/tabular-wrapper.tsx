...
export const TabularRenderWrapper: React.FC<TabularRenderWrapperProps> = ({
  ...
  return (
    <div className="relative size-full">
      {false && (
        <div className="left-0 right-0 top-0 z-10 mb-4 rounded bg-yellow-100 px-global py-2 text-center text-sm text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200">
