...
export const WorkbenchView: React.FC<IWorkbenchViewProps> = ({ mode }) => {
  ...
  return (
    <div
      ref={ref}
      className="relative w-full flex-1 overflow-hidden rounded-l-xl rounded-br-xl rounded-tr-xl border-b border-r border-t border-input bg-slate-1 shadow-sm"
    >
      <AnimatePresence>
        {hasPages && hasPage ? (
          <motion.div
