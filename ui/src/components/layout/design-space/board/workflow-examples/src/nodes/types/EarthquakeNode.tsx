...
import { ExecutionResult, InfoValues, NodeComponentProps, NodeDefinition, NodeRow, STOP_EXECUTION } from './shared';
  ...
  if (!isLoading && !earthquakeData) {
    return (
      <div className="EarthquakeNode">
        <div className="EarthquakeNode-message">Connect this node and run the workflow to fetch earthquake data</div>
      </div>
    );
  }
