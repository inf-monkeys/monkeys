...
import { VinesAbstractBoolean } from '@/components/layout/workspace/vines-view/execution/data-display/abstract/node/boolean.tsx';
import { VinesAbstractImage } from '@/components/layout/workspace/vines-view/execution/data-display/abstract/node/image.tsx';
import { VinesAbstractPDB } from '@/components/layout/workspace/vines-view/execution/data-display/abstract/node/pdb.tsx';
import { VinesAbstractString } from '@/components/layout/workspace/vines-view/execution/data-display/abstract/node/string.tsx';
import { VinesAbstractUrl } from '@/components/layout/workspace/vines-view/execution/data-display/abstract/node/url.tsx';
import { VinesAbstractVideo } from '@/components/layout/workspace/vines-view/execution/data-display/abstract/node/video.tsx';
import { previewDataGenerator } from '@/components/layout/workspace/vines-view/execution/data-display/abstract/utils.ts';
