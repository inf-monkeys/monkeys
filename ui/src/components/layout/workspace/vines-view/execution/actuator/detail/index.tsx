...
import { VinesActuatorDetailContent } from '@/components/layout/workspace/vines-view/execution/actuator/detail/content';
import { VinesActuatorDetailHeader } from '@/components/layout/workspace/vines-view/execution/actuator/detail/header.tsx';
