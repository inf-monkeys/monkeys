...
import { ScheduleTrigger } from '@/components/layout/workspace/vines-view/flow/headless-modal/endpoint/start-tool/workflow-input-config/triggers/trigger-selector/schedule-trigger';
import { WebhookTrigger } from '@/components/layout/workspace/vines-view/flow/headless-modal/endpoint/start-tool/workflow-input-config/triggers/trigger-selector/webhook-trigger';
                ...
                >
                  <div className="relative flex h-12 w-12 flex-shrink-0 items-end justify-end overflow-hidden rounded-lg border-input shadow-md">
                    <div className="absolute">
                      <VinesIcon className="size-full" size="lg" src={icon} disabledPreview />
                    </div>
                  </div>
