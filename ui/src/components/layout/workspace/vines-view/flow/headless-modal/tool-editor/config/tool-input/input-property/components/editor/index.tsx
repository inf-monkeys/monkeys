    ...
    <div className="relative h-80">
      {error && (
        <span
          ...
          className="text-xxs text-danger absolute right-6 top-2 z-50 select-none rounded bg-gray-600 bg-opacity-10 p-2 backdrop-blur-xl transition-opacity hover:opacity-0"
        >
          {error}
        </span>
      )}
