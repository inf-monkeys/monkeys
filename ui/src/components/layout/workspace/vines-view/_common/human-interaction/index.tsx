...
import { objectToArray } from '@/components/layout/workspace/vines-view/_common/human-interaction/utils.ts';
        ...
        <AnimatePresence>
          {isCompleted || disableTaskId === taskId ? (
            ...
            >
              ...
              {!isEmpty && (
                <div className="flex max-h-[25rem] w-full shrink-0 grow-0 flex-wrap items-center justify-center gap-global overflow-x-clip rounded-md border border-input bg-muted py-2">
              ...
              <div
                className={cn(
                  ...
                  isEmpty && 'h-[calc(100%-44px)] scale-110 justify-center gap-global',
                )}
              >
                <Button
                  icon={<LogOut />}
