    ...
    <div className="artist-main-container">
      ...
      <div className="content-container">
        <div className="content-content fixed z-10 flex flex-col">
          <div className="slogan-section">
            ...
            <div className="enter-button" onClick={handleToWorkbench}>
              <svg
                ...
                version="1.1"
                width="24"
                height="22.7998046875"
                viewBox="0 0 24 22.7998046875"
              >
                <g>
                  <g>
                    <path
          ...
          <div className="center-content flex flex-1 flex-col items-center justify-center">{/* 内容区域 */}</div>
