...
export const AssetDetail: React.FC = () => {
  ...
  const { assetId } = useParams({ from: '/$teamId/nav/$navId/$assetId/' });
  ...
  const handleBack = () => {
    navigate({ to: '/$teamId/nav/concept-design:design-assets' as any });
  };
...
export const Route = createLazyFileRoute('/$teamId/nav/$navId/$assetId/')({
