// Migration template for Data Management V2 tables
// NOTE: This is a template for manual use. Adjust timestamp and indexes as needed.
...
export class CreateDataManagementV2Tables1769999999999 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // NOTE: For LIKE prefix search on path, consider text_pattern_ops.
    await queryRunner.query(`
