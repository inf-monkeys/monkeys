...
func NewOpenSearchClient(cfg OpenSearchConfig) (*OpenSearchClient, error) {
  if cfg.URL == "" {
    return nil, errors.New("opensearch url required")
  }
...
func (c *OpenSearchClient) SearchAssetIDs(ctx context.Context, appID, teamID string, viewTagGroups [][]string, userTags []string, limit int, pageToken string) ([]string, string, error) {
  ...
  if res.StatusCode >= http.StatusBadRequest {
    ...
    return nil, "", fmt.Errorf("opensearch error: %s", string(raw))
  }
