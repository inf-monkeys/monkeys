...
const TeamIdSettingsUserIndexComponentImport = createFileRoute(
  '/$teamId/settings/user/',
)()
const TeamIdSettingsUserToggleUserPhoneModalComponentImport = createFileRoute(
  '/$teamId/settings/user/toggle-user-phone-modal',
)()
...
const TeamIdSettingsUserIndexComponentRoute =
  TeamIdSettingsUserIndexComponentImport.update({
    path: '/$teamId/settings/user/',
    getParentRoute: () => rootRoute,
  } as any).update({
    component: lazyRouteComponent(
      () => import('./pages/$teamId/settings/user/index.component'),
      'component',
    ),
  })

const TeamIdSettingsUserToggleUserPhoneModalComponentRoute =
  TeamIdSettingsUserToggleUserPhoneModalComponentImport.update({
    path: '/$teamId/settings/user/toggle-user-phone-modal',
    getParentRoute: () => rootRoute,
  } as any).update({
    component: lazyRouteComponent(
      () =>
        import(
          './pages/$teamId/settings/user/toggle-user-phone-modal.component'
        ),
      'component',
    ),
  })
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/$teamId/settings/user/toggle-user-phone-modal': {
      preLoaderRoute: typeof TeamIdSettingsUserToggleUserPhoneModalComponentImport
      parentRoute: typeof rootRoute
    }
    '/$teamId/settings/user/': {
      preLoaderRoute: typeof TeamIdSettingsUserIndexComponentImport
      parentRoute: typeof rootRoute
    }
  }
}
...
export const routeTree = rootRoute.addChildren([
  ...
  TeamIdSettingsUserToggleUserPhoneModalComponentRoute,
  TeamIdSettingsUserIndexComponentRoute,
])
